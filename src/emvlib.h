...
int cEMVPedVerifyPlainPin (unsigned char IccSlot, unsigned char *ExpPinLenIn, unsigned char *IccRespOut, unsigned char Mode, ulong TimeoutMs);
int cEMVPedVerifyCipherPin (unsigned char IccSlot, unsigned char *ExpPinLenIn, RSA_PINKEY_L2 *RsaPinKeyIn, unsigned char *IccRespOut, unsigned char Mode, ulong TimeoutMs);
