...
namespace :pax do
  ...
  task :link => BIN do
    ...
    sh "#{File.join(PAX_LIB_ROOT, "sdk", "toolchains", "arm-4.4.1", "bin", "arm-none-linux-gnueabi-gcc")} -o\"app.nostrip\" #{BIN.join(" ")} -L\"#{File.join(PAX_LIB_ROOT, "sdk", "platforms", "paxngfp_201205", "lib")}\" -losal -Wl,-rpath=//opt/lib -Wl,-rpath=./lib -Wl,-rpath-link,\"#{File.join(PAX_LIB_ROOT, "sdk", "platforms", "paxngfp_201205", "lib")}\" -lm -lMID -lcrypto -lD_DEVICE_LIB_v605 -lF_AE_LIB_v250_02 -lF_DPAS_LIB_v150_03 -lF_EMV_LIB_v651_03 -lF_ENTRY_LIB_v552 -lF_MC_LIB_v551_02 -lF_PUBLIC_LIB_v105 -lF_WAVE_LIB_v351 -lPPCOMP_Prolin_v132 -liniparser -lfreetype -lpng -lpthread -lts -lxui -lbarcode #{File.join(MRUBY_LIB, "build", "pax", "lib", "libmruby.a")} -L\"#{File.join(PAX_LIB_ROOT, "emv")}\" -L\"#{File.join(PAX_LIB_ROOT, "barcode")}\""
