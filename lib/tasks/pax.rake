...
namespace :pax do
  ...
  task :link => BIN do
    ...
    sh "#{File.join(PAX_LIB_ROOT, "sdk", "toolchains", "arm-4.4.1", "bin", "arm-none-linux-gnueabi-gcc")} -o\"app.nostrip\" #{BIN.join(" ")} -L\"#{File.join(PAX_LIB_ROOT, "sdk", "platforms", "paxngfp_201205", "lib")}\" -losal -Wl,-rpath=//opt/lib -Wl,-rpath=./lib -Wl,-rpath-link,\"#{File.join(PAX_LIB_ROOT, "sdk", "platforms", "paxngfp_201205", "lib")}\" -lm -lMID -lcrypto -lD_DEVICE_LIB_v606 -lF_AE_LIB_v250_02 -lF_DPAS_LIB_v151 -lF_EMV_LIB_v652_06 -lF_ENTRY_LIB_v553_01 -lF_MC_LIB_v552_01 -lF_PUBLIC_LIB_v107 -lF_WAVE_LIB_v353 -lPPCOMP_Prolin_v135 -liniparser -lfreetype -lpng -lpthread -lts -lxui -lbarcode #{File.join(MRUBY_LIB, "build", "pax", "lib", "libmruby.a")} -L\"#{File.join(PAX_LIB_ROOT, "emv")}\" -L\"#{File.join(PAX_LIB_ROOT, "barcode")}\""
